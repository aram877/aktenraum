...
// The /inbox route is kept as a redirect target in router.tsx but its
// content has moved to /library?tab=review (see Library.tsx). This component
// stays as a defensive fallback in case the redirect is ever removed.
