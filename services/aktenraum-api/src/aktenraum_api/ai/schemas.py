...
class DocumentSummary(BaseModel):
    ...
    # All user-facing tags on the document (everything that is NOT a
    # lifecycle / internal tag). Lets the SPA detect membership in
    # `wichtig` for the star toggle without a second per-doc fetch.
    tags: list[str] = Field(default_factory=list)
